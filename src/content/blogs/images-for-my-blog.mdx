...
Implemented using [Aceternity Dither Shader](https://ui.aceternity.com/components/dither-shader) and [CossUI Components](https://coss.com/ui) based on ShadCN components. This is just created for consistent images on my site.
